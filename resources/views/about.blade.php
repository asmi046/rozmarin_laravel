        ...
        <div class="inner">
            ...
            <ol class="work-stages-list">
                <li class="work-stages-list-item">
                    ...
                    <p>
                        Выезжаем на участок, заполняем техническое задание со всеми пожеланиями владельца и членов его семьи, анализируем территорию, архитектуру строений и окружающего пространства, производим фото и видеосъёмку.
                    </p>
                </li>
                <li class="work-stages-list-item">
                    <span class="work-stages-list-item__caption">Концепция</span>
                    <p>
                        Создаем идею будущего сада, разрабатываем оптимальное зонирование, подбираем мощение, растения, варианты освещения и малых архитектурных форм, далее согласовываем эскиз с владельцем.
                    </p>
                </li>
                <li class="work-stages-list-item">
                ...
                <li class="work-stages-list-item">
                    ...
                    <p>
                        По желанию владельца комплексно ухаживаем за реализованным садом в течение всего сезона или периодически выезжаем для осуществления сезонных работ (весенняя обрезка растений, подготовка сада к летнему или зимнему сезону, посадка огородных культур, обработка от болезней и вредителей, укрытие растений на зиму, разовые консультации и т.д.).
                    </p>
                </li>
            </ol>
